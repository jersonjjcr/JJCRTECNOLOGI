...
window.addEventListener('load', () => {
    ...
    // Añadir animación CSS para el spinner
...
// Añadir estilos de error al CSS dinámicamente
...
errorStyles.textContent = `
    ...
    .form-group.error input[type="email"]::after {
        content: 'Ingresa un email válido';
    }
`;
document.head.appendChild(errorStyles);

console.log('🚀 JJCR Tecnología - Landing page cargada exitosamente!');
